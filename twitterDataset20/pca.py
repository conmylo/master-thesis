...
with tqdm(total=len(unique_users) * 5, desc="Processing Users with K-Fold", unit="iteration") as pbar:
    ...
    for user_id in unique_users:
        ...
        for train_index, test_index in kf.split(user_data):
            ...
            impostor_data_pca = pca.transform(impostor_data_scaled)
            ...
            user_decision_scores = svm.decision_function(X_test_pca)
            impostor_decision_scores = svm.decision_function(impostor_data_pca)
